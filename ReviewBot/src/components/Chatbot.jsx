...
//       const reviewsResponse = await axios.get('http://localhost:3001/linkInput', { params: { link } });
//       const reviews = reviewsResponse.data.reviews;

//       // Step 2: Perform sentiment analysis on the reviews
//       const sentimentResponse = await axios.post('http://localhost:3001/analyzeSentiment', { reviews });
